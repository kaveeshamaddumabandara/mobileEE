...
const CaregiverForgotPasswordScreen: React.FC<Props> = ({navigation}) => {
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={styles.titleSection}>
            ...
            <Text style={styles.roleBadge}>Caregiver</Text>
            <Text style={styles.title}>Forgot Password?</Text>
            <Text style={styles.subtitle}>
              Enter your registered caregiver email and we'll send you
          ...
          <View style={styles.formCard}>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Caregiver Email Address *</Text>
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="Enter your caregiver email"
...
export default CaregiverForgotPasswordScreen;
